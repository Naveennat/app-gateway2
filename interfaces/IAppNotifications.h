...
// This repository builds AppGateway in isolation. In upstream Thunder/entservices-infra
// environments, some of these IDs are provided by generated headers or other SDK headers.
// Provide minimal fallbacks here to keep compilation working.
#ifndef ID_APP_NOTIFICATIONS_HANDLER_INTERNAL_EMITTER
#define ID_APP_NOTIFICATIONS_HANDLER_INTERNAL_EMITTER (ID_APP_NOTIFICATIONS_HANDLER_INTERNAL + 1)
#endif
...
namespace WPEFramework
{
    namespace Exchange
    {
        ...
        struct EXTERNAL IAppNotifications : virtual public Core::IUnknown
        {
            ...
            // Compatibility hook:
            // Some AppGateway code paths use IAppNotifications::Notify(eventName, payload)
            // for best-effort cross-component signalling.
            virtual Core::hresult Notify(const string& event /* @in */,
        ...
        struct EXTERNAL IAppNotificationHandler : virtual public Core::IUnknown
        {
            ...
            // @returns Core::hresult
            virtual Core::hresult HandleAppEventNotifier(IEmitter* emitCb,
                                                         const string& event,
                                                         bool listen,
                                                         bool& status /* @out */) = 0;
        };
