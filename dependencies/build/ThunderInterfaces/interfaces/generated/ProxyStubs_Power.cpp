...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePowerStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IPower::PCState _parameter_cd4ce8da = reader.Number<Exchange::IPower::PCState>();
            const uint32_t _parameter_2262cfba = reader.Number<uint32_t>();

            uint32_t result = implementation->SetState(_parameter_cd4ce8da, _parameter_2262cfba);
    ...
    public:
        ...
        uint32_t SetState(const Exchange::IPower::PCState _parameter_cd4ce8da, const uint32_t _parameter_2262cfba) override
        {
            IPCMessage message(BaseClass::Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IPower::PCState>(_parameter_cd4ce8da);
            writer.Number<uint32_t>(_parameter_2262cfba);
