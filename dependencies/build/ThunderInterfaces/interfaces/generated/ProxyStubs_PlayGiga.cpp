...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_9fb2d537 = reader.Text();
            const string _parameter_9fc1f1dd = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_9fb2d537), static_cast<const string&>(_parameter_9fc1f1dd));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_9fb2d537, const string& _parameter_9fc1f1dd) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_9fb2d537));
            writer.Text(static_cast<const string&>(_parameter_9fc1f1dd));
