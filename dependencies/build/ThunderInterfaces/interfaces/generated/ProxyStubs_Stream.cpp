...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_72159b40Implementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_72159b40 = nullptr;
            ProxyStub::UnknownProxy* parameter_72159b40Proxy = nullptr;
            if (parameter_72159b40Implementation != 0) {
                parameter_72159b40Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_72159b40Implementation, false, _parameter_72159b40);

                ASSERT((_parameter_72159b40 != nullptr) && (parameter_72159b40Proxy != nullptr));
            }

            implementation->Callback(_parameter_72159b40);

            if (parameter_72159b40Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_72159b40Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_72159b40) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_72159b40));
