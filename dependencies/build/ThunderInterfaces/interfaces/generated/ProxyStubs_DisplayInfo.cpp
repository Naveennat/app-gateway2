...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance19A3C22D interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance19A3C22DStubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance19A3C22DStubMethods

    //
    // RPC::IIteratorTypeInstance5E95E2E6 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance5E95E2E6StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance5E95E2E6StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_0a0cdfe1Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_0a0cdfe1 = nullptr;
            ProxyStub::UnknownProxy* parameter_0a0cdfe1Proxy = nullptr;
            if (parameter_0a0cdfe1Implementation != 0) {
                parameter_0a0cdfe1Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_0a0cdfe1Implementation, false, _parameter_0a0cdfe1);

                ASSERT((_parameter_0a0cdfe1 != nullptr) && (parameter_0a0cdfe1Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_0a0cdfe1);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_0a0cdfe1Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_0a0cdfe1Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_2519aa56Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_2519aa56 = nullptr;
            ProxyStub::UnknownProxy* parameter_2519aa56Proxy = nullptr;
            if (parameter_2519aa56Implementation != 0) {
                parameter_2519aa56Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_2519aa56Implementation, false, _parameter_2519aa56);

                ASSERT((_parameter_2519aa56 != nullptr) && (parameter_2519aa56Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_2519aa56);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_2519aa56Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_2519aa56Proxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstance19A3C22D interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstance19A3C22DProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstance19A3C22DProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance19A3C22DProxy

    //
    // RPC::IIteratorTypeInstance5E95E2E6 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance5E95E2E6Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance5E95E2E6Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance5E95E2E6Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_0a0cdfe1) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0a0cdfe1));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_2519aa56) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2519aa56));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance19A3C22DStubMethods> RPCIteratorTypeInstance19A3C22DStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance5E95E2E6StubMethods> RPCIteratorTypeInstance5E95E2E6Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance19A3C22DProxy, RPCIteratorTypeInstance19A3C22DStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance5E95E2E6Proxy, RPCIteratorTypeInstance5E95E2E6Stub>();
