...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceF700845E interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceF700845EStubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceF700845EStubMethods

    //
    // RPC::IIteratorTypeInstance51D0AE96 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance51D0AE96StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance51D0AE96StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_a82b1ee5Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_a82b1ee5 = nullptr;
            ProxyStub::UnknownProxy* parameter_a82b1ee5Proxy = nullptr;
            if (parameter_a82b1ee5Implementation != 0) {
                parameter_a82b1ee5Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_a82b1ee5Implementation, false, _parameter_a82b1ee5);

                ASSERT((_parameter_a82b1ee5 != nullptr) && (parameter_a82b1ee5Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_a82b1ee5);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_a82b1ee5Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_a82b1ee5Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_ddf88d50Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_ddf88d50 = nullptr;
            ProxyStub::UnknownProxy* parameter_ddf88d50Proxy = nullptr;
            if (parameter_ddf88d50Implementation != 0) {
                parameter_ddf88d50Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_ddf88d50Implementation, false, _parameter_ddf88d50);

                ASSERT((_parameter_ddf88d50 != nullptr) && (parameter_ddf88d50Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_ddf88d50);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_ddf88d50Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_ddf88d50Proxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstanceF700845E interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstanceF700845EProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceF700845EProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceF700845EProxy

    //
    // RPC::IIteratorTypeInstance51D0AE96 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance51D0AE96Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance51D0AE96Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance51D0AE96Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_a82b1ee5) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a82b1ee5));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_ddf88d50) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ddf88d50));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceF700845EStubMethods> RPCIteratorTypeInstanceF700845EStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance51D0AE96StubMethods> RPCIteratorTypeInstance51D0AE96Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceF700845EProxy, RPCIteratorTypeInstanceF700845EStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance51D0AE96Proxy, RPCIteratorTypeInstance51D0AE96Stub>();
