use crate::model::badger::{BadgerDataField, BadgerPermission};
use crate::model::permissions::firebolt::{
    CapabilityRole, CapabilityRoleList, FireboltApi, FireboltPermission, FireboltPermissionRegistry,
};

use serde::Deserialize;
use thunder_ripple_sdk::ripple_sdk::{
    api::firebolt::fb_capabilities::CapabilityRole as Role, serde_yaml,
};
...
pub mod tests {
    ...
    use crate::model::permissions::thor_permission_registry::FireboltPermissionRegistry;
