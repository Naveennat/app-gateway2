...
int main()
{
    // Shared L0 bootstrap: ensures WorkerPool is running and disposes Core singletons at shutdown.
    ...
    // Totals + exit code (bootstrap guard already disposes Core singletons).
    if (failures == 0) {
