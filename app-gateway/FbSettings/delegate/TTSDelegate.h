...
class TTSDelegate : public BaseEventDelegate{
    public:
        TTSDelegate(PluginHost::IShell* shell, Exchange::IAppNotifications* appNotifications):BaseEventDelegate(appNotifications),mShell(shell),mNotificationHandler(*this){}
