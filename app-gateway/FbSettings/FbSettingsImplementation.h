...
namespace Plugin {
    class FbSettingsImplementation : public Exchange::IFbSettings, public Exchange::IConfiguration, public Exchange::IAppNotificationHandlerInternal, public Exchange::IAppGatewayRequestHandler {
    private:
