...
public:
    ...
    virtual int32_t startContainerFromSpec(const std::string& id,
                                           ...
                                           const std::string& displaySocket = std::string(),
...
public:
   ...
   int32_t startContainerFromBundle(const std::string& id,
    ...
    bool hibernateContainer(int32_t descriptor, const std::string& options) const;

    bool wakeupContainer(int32_t descriptor) const;
    ...
    bool removeContainerMount(int32_t descriptor, const std::string& source) const;
