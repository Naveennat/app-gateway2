...
tvError_t TvSettings::GetCurrentVideoSource(tvVideoSrcType_t *currentSource)
{
    EXPECT_NE(impl, nullptr);
    return impl->GetCurrentVideoSource(currentSource);
}

tvError_t TvSettings::SetCurrentComponentSaturation(tvDataComponentColor_t blSaturationColor, int saturation)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCurrentComponentSaturation(blSaturationColor, saturation);
}

tvError_t TvSettings::SetCurrentComponentHue(tvDataComponentColor_t blHueColor, int hue)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCurrentComponentHue(blHueColor, hue);
}

tvError_t TvSettings::SetCMSState(bool enableCMSState)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCMSState(enableCMSState);
}

tvError_t TvSettings::SetCustom2PointWhiteBalance(tvWBColor_t color, tvWBControl_t control, int value)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCustom2PointWhiteBalance(color, control, value);
}

tvError_t TvSettings::SetCurrentBacklightMode(tvBacklightMode_t blMode)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCurrentBacklightMode(blMode);
}

tvError_t TvSettings::SaveCustom2PointWhiteBalance(tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvWBColor_t color, tvWBControl_t control, int value)
{
    EXPECT_NE(impl, nullptr);
    return impl->SaveCustom2PointWhiteBalance(videoSrcType, pq_mode, videoFormatType, color, control, value);
}

tvError_t TvSettings::SetCurrentComponentLuma(tvDataComponentColor_t blLumaColor, int Luma)
{
    EXPECT_NE(impl, nullptr);
    return impl->SetCurrentComponentLuma(blLumaColor, Luma);
}

tvError_t TvSettings::SaveCMS(tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvComponentType_t component_type, tvDataComponentColor_t color_type, int cms_value)
{
    EXPECT_NE(impl, nullptr);
    return impl->SaveCMS(videoSrcType, pq_mode, videoFormatType, component_type, color_type, cms_value);
}
...
tvError_t (*GetCurrentVideoSource)(tvVideoSrcType_t *currentSource) = &TvSettings::GetCurrentVideoSource;
tvError_t (*SetCurrentComponentSaturation)(tvDataComponentColor_t blSaturationColor, int saturation) = &TvSettings::SetCurrentComponentSaturation;
tvError_t (*SetCurrentComponentHue)(tvDataComponentColor_t blHueColor, int hue) = &TvSettings::SetCurrentComponentHue;
tvError_t (*SetCMSState)(bool enableCMSState) = &TvSettings::SetCMSState;
tvError_t (*SetCustom2PointWhiteBalance)(tvWBColor_t color, tvWBControl_t control, int value) = &TvSettings::SetCustom2PointWhiteBalance;
tvError_t (*SetCurrentBacklightMode)(tvBacklightMode_t blMode) = &TvSettings::SetCurrentBacklightMode;
tvError_t (*SaveCustom2PointWhiteBalance)(tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvWBColor_t color, tvWBControl_t control, int value) = &TvSettings::SaveCustom2PointWhiteBalance;
tvError_t (*SetCurrentComponentLuma)(tvDataComponentColor_t blLumaColor, int Luma) = &TvSettings::SetCurrentComponentLuma;
tvError_t (*SaveCMS)(tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvComponentType_t component_type, tvDataComponentColor_t color_type, int cms_value) = &TvSettings::SaveCMS;