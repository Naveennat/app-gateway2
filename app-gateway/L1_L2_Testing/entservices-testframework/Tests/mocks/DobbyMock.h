...
public:
    ...
    MOCK_METHOD(bool, hibernateContainer, (int32_t descriptor, const std::string& options), (const, override));
    MOCK_METHOD(bool, wakeupContainer, (int32_t descriptor), (const, override));
    MOCK_METHOD(bool, addContainerMount, (int32_t descriptor, 
                           const std::string& source, 
                           const std::string& destination,  
                           const std::vector<std::string>& mountFlags, 
                           const std::string& mountData), (const, override));
    MOCK_METHOD(bool, removeContainerMount, (int32_t descriptor, const std::string& source), (const, override));
    MOCK_METHOD(bool, addAnnotation, (int32_t cd,
