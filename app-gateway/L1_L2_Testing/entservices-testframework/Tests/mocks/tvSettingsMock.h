...
public:
    ...
    MOCK_METHOD(tvError_t, GetCurrentVideoSource, (tvVideoSrcType_t* currentSource), ());
    MOCK_METHOD(tvError_t, SetCurrentComponentSaturation, (tvDataComponentColor_t blSaturationColor, int saturation), ());
    MOCK_METHOD(tvError_t, SetCurrentComponentHue, (tvDataComponentColor_t blHueColor, int hue), ());
    MOCK_METHOD(tvError_t, SetCMSState, (bool enableCMSState), ());
    MOCK_METHOD(tvError_t, SetCustom2PointWhiteBalance, (tvWBColor_t color, tvWBControl_t control, int value), ());
    MOCK_METHOD(tvError_t, SetCurrentBacklightMode, (tvBacklightMode_t blMode), ());
    MOCK_METHOD(tvError_t, SaveCustom2PointWhiteBalance, (tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvWBColor_t color, tvWBControl_t control, int value), ());
    MOCK_METHOD(tvError_t, SetCurrentComponentLuma, (tvDataComponentColor_t blLumaColor, int Luma), ());
    MOCK_METHOD(tvError_t, SaveCMS, (tvVideoSrcType_t videoSrcType, int pq_mode, tvVideoFormatType_t videoFormatType, tvComponentType_t component_type, tvDataComponentColor_t color_type, int cms_value), ());
