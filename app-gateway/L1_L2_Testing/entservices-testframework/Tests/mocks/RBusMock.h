...
public:
	 ...
	 : RBusApiImpl()
	{
	   ...
	   ON_CALL(*this, rbus_open(::testing::_, ::testing::_))
	        .WillByDefault(::testing::Return(RBUS_ERROR_SUCCESS));

	   ON_CALL(*this, rbusMethod_InvokeAsync(::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_))
	   ...
	   ON_CALL(*this, rbusObject_GetValue(::testing::_, ::testing::_))
	        .WillByDefault(::testing::Invoke(
	   ...
	   ON_CALL(*this, rbusValue_GetString(::testing::_, ::testing::_))
	        .WillByDefault(::testing::Return("SUCCESS"));

	   ON_CALL(*this, rbus_close(::testing::_))
        	.WillByDefault(::testing::Return(RBUS_ERROR_SUCCESS));
	}
