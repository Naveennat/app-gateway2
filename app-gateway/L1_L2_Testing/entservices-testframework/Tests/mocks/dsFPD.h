...
class dsFPDImpl {
public:
    virtual ~dsFPDImpl() = default;
    
    virtual dsError_t dsFPInit() = 0;
    virtual dsError_t dsSetFPBlink(dsFPDIndicator_t eIndicator, unsigned int uBlinkDuration, unsigned int uBlinkIterations) = 0;
    virtual dsError_t dsSetFPBrightness(dsFPDIndicator_t eIndicator, dsFPDBrightness_t eBrightness) = 0;
    virtual dsError_t dsGetFPBrightness(dsFPDIndicator_t eIndicator, dsFPDBrightness_t* pBrightness) = 0;
    virtual dsError_t dsSetFPState(dsFPDIndicator_t eIndicator, dsFPDState_t state) = 0;
    virtual dsError_t dsGetFPState(dsFPDIndicator_t eIndicator, dsFPDState_t* state) = 0;
    virtual dsError_t dsSetFPColor(dsFPDIndicator_t eIndicator, dsFPDColor_t eColor) = 0;
    virtual dsError_t dsGetFPColor(dsFPDIndicator_t eIndicator, dsFPDColor_t* pColor) = 0;
    virtual dsError_t dsFPTerm(void) = 0;
    virtual dsError_t dsFPGetLEDState(dsFPDLedState_t* state) = 0;
    virtual dsError_t dsFPSetLEDState(dsFPDLedState_t state) = 0;
    virtual dsError_t dsFPGetSupportedLEDStates(unsigned int* states) = 0;
};

class dsFPDApi {
protected:
    static dsFPDImpl* impl;

public:
    dsFPDApi();
    dsFPDApi(const dsFPDApi &obj) = delete;
    static void setImpl(dsFPDImpl* newImpl);
    static dsError_t dsFPInit();
    static dsError_t dsSetFPBlink(dsFPDIndicator_t eIndicator, unsigned int uBlinkDuration, unsigned int uBlinkIterations);
    static dsError_t dsSetFPBrightness(dsFPDIndicator_t eIndicator, dsFPDBrightness_t eBrightness);
    static dsError_t dsGetFPBrightness(dsFPDIndicator_t eIndicator, dsFPDBrightness_t* pBrightness);
    static dsError_t dsSetFPState(dsFPDIndicator_t eIndicator, dsFPDState_t state);
    static dsError_t dsGetFPState(dsFPDIndicator_t eIndicator, dsFPDState_t* state);
    static dsError_t dsSetFPColor(dsFPDIndicator_t eIndicator, dsFPDColor_t eColor);
    static dsError_t dsGetFPColor(dsFPDIndicator_t eIndicator, dsFPDColor_t* pColor);
    static dsError_t dsFPTerm();
    static dsError_t dsFPGetLEDState(dsFPDLedState_t* state);
    static dsError_t dsFPSetLEDState(dsFPDLedState_t state);
    static dsError_t dsFPGetSupportedLEDStates(unsigned int* states);
};

extern dsError_t (*dsFPInit)();
extern dsError_t (*dsSetFPBlink)(dsFPDIndicator_t eIndicator, unsigned int uBlinkDuration, unsigned int uBlinkIterations);
extern dsError_t (*dsSetFPBrightness)(dsFPDIndicator_t eIndicator, dsFPDBrightness_t eBrightness);
extern dsError_t (*dsGetFPBrightness)(dsFPDIndicator_t eIndicator, dsFPDBrightness_t* pBrightness);
extern dsError_t (*dsSetFPState)(dsFPDIndicator_t eIndicator, dsFPDState_t state);
extern dsError_t (*dsGetFPState)(dsFPDIndicator_t eIndicator, dsFPDState_t* state);
extern dsError_t (*dsSetFPColor)(dsFPDIndicator_t eIndicator, dsFPDColor_t eColor);
extern dsError_t (*dsGetFPColor)(dsFPDIndicator_t eIndicator, dsFPDColor_t* pColor);
extern dsError_t (*dsFPTerm)();
extern dsError_t (*dsFPGetLEDState)(dsFPDLedState_t* state);
extern dsError_t (*dsFPSetLEDState)(dsFPDLedState_t state);
extern dsError_t (*dsFPGetSupportedLEDStates)(unsigned int* states);
