...
public:
    ...
    virtual tvError_t GetCurrentVideoSource(tvVideoSrcType_t *currentSource) = 0;
    virtual tvError_t SetCurrentComponentSaturation(tvDataComponentColor_t blSaturationColor, int saturation) = 0;
    virtual tvError_t SetCurrentComponentHue(tvDataComponentColor_t blHueColor, int hue) = 0;
    virtual tvError_t SetCMSState(bool enableCMSState) = 0;
    virtual tvError_t SetCustom2PointWhiteBalance(tvWBColor_t color, tvWBControl_t control, int value) = 0;
    virtual tvError_t SetCurrentBacklightMode(tvBacklightMode_t blMode) = 0;
    virtual tvError_t SaveCustom2PointWhiteBalance(tvVideoSrcType_t videoSrcType, int pq_mode,tvVideoFormatType_t videoFormatType, tvWBColor_t color, tvWBControl_t control, int value) = 0;
    virtual tvError_t SetCurrentComponentLuma(tvDataComponentColor_t blLumaColor, int Luma) = 0;
    virtual tvError_t SaveCMS(tvVideoSrcType_t videoSrcType, int pq_mode,tvVideoFormatType_t videoFormatType,tvComponentType_t component_type,tvDataComponentColor_t color_type,int cms_value) = 0;
    //tvSettingsODM.h
...
public:
    ...
    static tvError_t GetCurrentVideoSource(tvVideoSrcType_t *currentSource);
    static tvError_t SetCurrentComponentSaturation(tvDataComponentColor_t blSaturationColor, int saturation);
    static tvError_t SetCurrentComponentHue(tvDataComponentColor_t blHueColor, int hue);
    static tvError_t SetCMSState(bool enableCMSState);
    static tvError_t SetCustom2PointWhiteBalance(tvWBColor_t color, tvWBControl_t control, int value);
    static tvError_t SetCurrentBacklightMode(tvBacklightMode_t blMode);
    static tvError_t SaveCustom2PointWhiteBalance(tvVideoSrcType_t videoSrcType, int pq_mode,tvVideoFormatType_t videoFormatType, tvWBColor_t color, tvWBControl_t control, int value);
    static tvError_t SetCurrentComponentLuma(tvDataComponentColor_t blLumaColor, int Luma);
    static tvError_t SaveCMS(tvVideoSrcType_t videoSrcType, int pq_mode,tvVideoFormatType_t videoFormatType,tvComponentType_t component_type,tvDataComponentColor_t color_type,int cms_value);
    //tvSettingsODM.h
...
extern tvError_t (*GetCurrentVideoSource)(tvVideoSrcType_t *);
extern tvError_t (*SetCurrentComponentSaturation)(tvDataComponentColor_t , int);
extern tvError_t (*SetCurrentComponentHue)(tvDataComponentColor_t , int);
extern tvError_t (*SetCMSState)(bool);
extern tvError_t (*SetCustom2PointWhiteBalance)(tvWBColor_t , tvWBControl_t , int);
extern tvError_t (*SetCurrentBacklightMode)(tvBacklightMode_t);
extern tvError_t (*SaveCustom2PointWhiteBalance)(tvVideoSrcType_t, int, tvVideoFormatType_t, tvWBColor_t, tvWBControl_t, int);
extern tvError_t (*SetCurrentComponentLuma)(tvDataComponentColor_t, int);
extern tvError_t (*SaveCMS)(tvVideoSrcType_t, int, tvVideoFormatType_t, tvComponentType_t, tvDataComponentColor_t, int);
//tvSettingsODM.h
