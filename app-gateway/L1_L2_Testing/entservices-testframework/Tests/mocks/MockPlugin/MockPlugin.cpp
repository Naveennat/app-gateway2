...
namespace WPEFramework
{
    namespace Plugin
    {
        ...
        PowerManagerImpl* MockPlugin::_powerManagerHalMock = nullptr;
        mfrImpl* MockPlugin::_mfrImpl = nullptr;
        ...
        const std::string MockPlugin::Initialize(PluginHost::IShell *service)
        {
            ...
            _powerManagerHalMock = MockAccessor<PowerManagerImpl>::getPtr();
            assert (nullptr != _powerManagerHalMock);
            _mfrImpl = MockAccessor<mfrImpl>::getPtr();
            assert (nullptr != _mfrImpl);
...
//
        ...
        uint32_t MockPlugin::PLAT_API_SetPowerState(uint32_t newState)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_API_GetPowerState(uint32_t& curState) const
        {
        ...
        uint32_t MockPlugin::PLAT_API_SetWakeupSrc(uint32_t srcType, bool enable)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_API_GetWakeupSrc(uint32_t srcType, bool& enable)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_Reset(uint32_t newState)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_TERM(void)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_DS_INIT(void)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_DS_SetDeepSleep(uint32_t deep_sleep_timeout, bool& isGPIOWakeup, bool networkStandby)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_DS_DeepSleepWakeup(void)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::PLAT_DS_GetLastWakeupReason(uint32_t &wakeupReason) const
        {
        ...
        uint32_t MockPlugin::PLAT_DS_GetLastWakeupKeyCode(uint32_t &KeyCode) const
        {
        ...
        uint32_t MockPlugin::PLAT_DS_TERM(void)
        {
            TEST_LOG("Entry");
...
//
        ...
        uint32_t MockPlugin::mfrGetTempThresholds(int &high /* @out  */, int &critical /* @out  */) const
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::mfrSetTempThresholds(int tempHigh /* @in  */, int tempCritical /* @in  */)
        {
            TEST_LOG("Entry");
        ...
        uint32_t MockPlugin::mfrGetTemperature(uint32_t &curState /* @out  */, int &curTemperature /* @out  */, int &wifiTemperature /* @out  */) const
        {
            TEST_LOG("Entry");
