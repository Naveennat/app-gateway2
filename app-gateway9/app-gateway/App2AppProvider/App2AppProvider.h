...
public:
    // PUBLIC_INTERFACE
    uint32_t registerProvider(const Core::JSON::Object& params, Core::JSON::Object& response);

    // PUBLIC_INTERFACE
    uint32_t invokeProvider(const Core::JSON::Object& params, Core::JSON::Object& response);

    // PUBLIC_INTERFACE
    uint32_t handleProviderResponse(const Core::JSON::Object& params, Core::JSON::Object& response);

    // PUBLIC_INTERFACE
    uint32_t handleProviderError(const Core::JSON::Object& params, Core::JSON::Object& response);

private:
    // Helpers for parsing and validation
    bool ParseContext(const Core::JSON::Object& obj, ConsumerContext& outCtx, string& error) const;
    bool ParseProviderContext(const Core::JSON::Object& obj, ProviderContext& outCtx, string& error) const;
