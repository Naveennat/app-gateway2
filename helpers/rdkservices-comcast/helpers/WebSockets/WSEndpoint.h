...
class WSEndpoint : public Role<WSEndpoint<Role, MessagingInterface, PingPong, Encryption> >,
                   ...
                   private Encryption<WSEndpoint<Role, MessagingInterface, PingPong, Encryption>, Role<WSEndpoint<Role, MessagingInterface, PingPong, Encryption> > >
{
public:
    WSEndpoint(const char *name = "Unnamed");
    ~WSEndpoint();
